...
| Suite de tests | ✅ 501/501 | 17 fichiers de test, 100% passants |
...
# Lancer la suite de tests (doit être 501/501)
npx hardhat test
```
...
3. **Les logs de test** : sortie de `npx hardhat test` (501 tests)
